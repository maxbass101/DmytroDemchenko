...
***************************************************************************** */
    ...
    const buttonPlay = document.querySelector(".audioplayer__button-play");
    const buttonPrev = document.querySelector(".audioplayer__button-prev");
    const buttonNext = document.querySelector(".audioplayer__button-next");
    const audio = document.querySelector(".audioplayer__audio");
    const progressContainer = document.querySelector(".audioplayer__progress-container");
    const progressLine = document.querySelector(".audioplayer__progress-line");
    const nameSong = document.querySelector(".audioplayer__row-song");
    const playPause = document.querySelector(".play-pause");
    const songs = [ "Ambient Motivational", "Ambient Uplifting", "Beauty Motivational", "Cinematic", "Corporate Business", "Corporate Motivational", "Epic", "Halloween-horror" ];
    let songIndex = 0;
    ...
    function playSong() {
        playPause.src = "./img/foollscreen/audioplayer/pause.svg";
        player.classList.add("playerIsActive");
        audio.play();
    }
    function pauseSong() {
        playPause.src = "./img/foollscreen/audioplayer/play.svg";
        player.classList.remove("playerIsActive");
        audio.pause();
    }
    buttonPlay.addEventListener("click", (() => {
        const isPlaying = player.classList.contains("playerIsActive");
    ...
    function script_updateProgress(e) {
        const {duration, currentTime} = e.srcElement;
        const progressPercent = currentTime / duration * 100;
        progressLine.style.width = `${progressPercent}%`;
    }
    audio.addEventListener("timeupdate", script_updateProgress);
    ...
    const player2 = document.querySelector(".audioplayer2");
    const buttonPlay2 = document.querySelector(".audioplayer2__button-play");
    const buttonPrev2 = document.querySelector(".audioplayer2__button-prev");
    const buttonNext2 = document.querySelector(".audioplayer2__button-next");
    const audio2 = document.querySelector(".audioplayer2__audio");
    const progressContainer2 = document.querySelector(".audioplayer2__progress-container");
    const progressLine2 = document.querySelector(".audioplayer2__progress-line");
    const nameSong2 = document.querySelector(".audioplayer2__row-song");
    const playPause2 = document.querySelector(".play-pause2");
    ...
    function loadSong2(song) {
        nameSong2.innerHTML = song;
        audio2.src = `files/${song}.mp3`;
    }
    loadSong2(songs2[songIndex2]);
    function playSong2() {
        playPause2.src = "./img/foollscreen/audioplayer/pause.svg";
        player2.classList.add("playerIsActive");
        audio2.play();
    }
    function pauseSong2() {
        playPause2.src = "./img/foollscreen/audioplayer/play.svg";
        player2.classList.remove("playerIsActive");
        audio2.pause();
    }
    buttonPlay2.addEventListener("click", (() => {
        const isPlaying = player2.classList.contains("playerIsActive");
        if (isPlaying) pauseSong2(); else playSong2();
    }));
    function nextSong2() {
        songIndex2++;
        if (songIndex2 > songs2.length - 1) songIndex2 = 0;
        loadSong2(songs2[songIndex2]);
        playSong2();
    }
    buttonNext2.addEventListener("click", nextSong2);
    function prevSong2() {
        songIndex2--;
        if (songIndex2 < 0) songIndex2 = songs2.length - 1;
        loadSong2(songs2[songIndex2]);
        playSong2();
    }
    buttonPrev2.addEventListener("click", prevSong2);
    function updateProgress2(e) {
        const {duration, currentTime} = e.srcElement;
        const progressPercent = currentTime / duration * 100;
        progressLine2.style.width = `${progressPercent}%`;
    }
